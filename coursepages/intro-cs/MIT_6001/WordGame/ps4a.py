...
#change this filepath to match the location of the directory
WORDLIST_FILENAME = "coursepages/intro-cs/MIT_6001/WordGame/words.txt"
...
def getWordScore(word, n):
    ...
    try:
        ...
        print("Not a valid letter option, please try again")
    ...
    while calculateHandlen(hand) != 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            while isValidWord(word, hand, wordList) != True:
                ...
                word = input("Please provide a new word: ")
...
def playGame(wordList):
    ...
    while user_input != 'e':
        ...
        while user_input != 'n' and user_input != 'r' and user_input != 'e':
            user_input = input("enter n for new hand, r to use the current hand, or e to exit the game: ")
